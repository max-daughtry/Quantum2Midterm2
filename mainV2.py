...
for n in range(5):
    ...
    while abs(res - target) > eps:
        ...
        # I basically just changed the index finder to do a binary search
        # instead of run through the entire length of the array (which obviously makes it like a gagillion times faster)
        min_guess_i = 0
        max_guess_i = min_i
